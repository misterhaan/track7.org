...
if(isset($_GET['tags']) && $_GET['tags']) {
	...
	$rss = new t7feed('all track7 guides', '/guides/', 'all guides posted at track7', 'copyright 2004 - 2016 track7');
...
if($guides = $db->query($guides))
	while($guide = $guides->fetch_object()) {
		...
		$rss->AddItem($guide->summary . '<p>» <a href="/guide/' . $guide->url . '/1">read more...</a></p>', $guide->title, '/guide/' . $guide->url . '/1', $guide->updated, '/guide/' . $guide->url . '/1', true);
	}
$rss->End();
