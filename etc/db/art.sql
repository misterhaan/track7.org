...
create table art (
	...
	deschtml text not null comment 'html description of this art, generated from descmd',
	descmd text not null comment 'description of this art in markdown (for editing)',
