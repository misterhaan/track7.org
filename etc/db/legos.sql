create table lego_models (
  ...
  deschtml text not null default '' comment 'html description of this lego model, generated from descmd',
  descmd text not null default '' comment 'description of this lego model in markdown (for editing)',
