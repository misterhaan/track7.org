<?
  ...
  if($_GET['tags'])
    if(substr($_GET['tags'], 0, 1) == '-') {
      $rss = new auFeed('bln entries', '/output/pen/bln/', 'entries posted on bln at track7 not tagged with ' . substr($_GET['tags'], 1), 'copyright 2007 track7');
      ...
      $rss = new auFeed('bln entries', '/output/pen/bln/', 'entries posted on bln at track7 tagged with ' . substr($_GET['tags']), 'copyright 2007 track7');
    ...
    $rss = new auFeed('all bln entries', '/output/pen/bln/', 'all entries posted on bln at track7', 'copyright 2007 track7');
