<?
  ...
  if($_GET['tags']) {
    $rss = new t7feed('blog entries', '/bln/', 'blog entries posted at track7 tagged with ' . $_GET['tags'], 'copyright 2008 - 2015 track7');
    ...
    $rss = new t7feed('all bln entries', '/bln/', 'all entries posted on bln at track7', 'copyright 2008 - 2016 track7');
