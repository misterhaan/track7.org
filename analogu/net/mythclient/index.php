...
?>
      <table class="data" cellspacing="0">
        ...
        <tbody>
          <tr class="current"><td>mythclient 64-bit installer</td><td class="number">0.2.0</td><td><a href="/files/analogu/net/mythclient/mythclient-v0.2.0_x64.msi">mythclient-v0.2.0_x64.msi</a></td><td class="number"><?=auFile::Size('mythclient-v0.2.0_x64.msi'); ?></td><td>windows installer</td></tr>
          <tr class="current"><td>mythclient 32-bit installer</td><td class="number">0.2.0</td><td><a href="/files/analogu/net/mythclient/mythclient-v0.2.0_x86.msi">mythclient-v0.2.0_x86.msi</a></td><td class="number"><?=auFile::Size('mythclient-v0.2.0_x86.msi'); ?></td><td>windows installer</td></tr>
          <tr class="current"><td>mythclient source</td><td class="number">0.2.0</td><td><a href="http://svn.track7.org/MythClient/releases/0.2/">0.2 source</a></td><td></td><td>subversion repository</td></tr>
