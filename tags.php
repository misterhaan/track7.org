      ...
      case 'list':
        switch($_GET['type']) {
          ...
          case 'photos':
            ...
            break;
          default:
            $ajax->Fail('unknown tag type for list.  supported tag types are: blog, guide, photos.');
            break;
        }
        break;
      case 'setdesc':
          ...
          if(isset($_POST['description']) && isset($_POST['id']) && $_POST['id'] == +$_POST['id'])
            switch($_GET['type']) {
              ...
              case 'photos':
                ...
                break;
              default:
                $ajax->Fail('unknown tag type for setdesc.  supported tag types are: blog, guide, photos.');
            }
          else
