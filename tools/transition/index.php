...
<table>
	...
	<tbody>
		<tr>
			...
			<td><?php echo $status[TR_BLOG]->stepnum; ?></td>
			<td><?php echo $status[TR_BLOG]->status; ?></td>
		</tr>
		<tr>
			<td><a href="guides.php">guides</a></td>
			<td><?php echo $status[TR_GUIDES]->stepnum; ?></td>
			<td><?php echo $status[TR_GUIDES]->status; ?></td>
		</tr>
		<tr>
