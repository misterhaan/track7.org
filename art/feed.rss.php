...
if(isset($_GET['tags']) && $_GET['tags']) {
	$rss = new t7feed('track7 art', '/art/', 'art posted at track7 tagged with ' . $_GET['tags'], 'copyright 2008 - 2017 track7');
	...
	$rss = new t7feed('all track7 art', '/art/', 'all art posted at track7', 'copyright 2008 - 2017 track7');
