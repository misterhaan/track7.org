<?php
  ...
  if(isset($_GET['ajax'])) {
    ...
    switch($_GET['ajax']) {
      ...
      case 'loadtime':
        if($user->IsLoggedIn()) {
          $ajax->Data->currenttime = t7format::LocalDate('h:i a', time());
        ...
        <form class=tabcontent id=contact>
          ...
          <div class=contactmethod>
            <label title="address at which track7 and (if you choose) users and / or visitors can contact you">
              ...
              <span class=field><input type=email id=email maxlength=64></span>
              <span class=validation title=""><img src="/images/status/checking.gif" alt=""></span>
            </label>
            <label>
              <span class=label>show to:</span>
              <span class=field><select id=vis_email>
                <option value=none>nobody</option>
                <option value=friends>my track7 friends</option>
                <option value=users>signed-in users</option>
                <option value=all>everyone (probably even spam bots)</option>
              </select></span>
            </label>
          </div>
          <div class=contactmethod>
            <label title="url of your personal website">
              ...
              <span class=field><input type=url id=website maxlength=64></span>
              <span class=validation title=""><img src="/images/status/checking.gif" alt=""></span>
            </label>
            <label>
              <span class=label>show to:</span>
              <span class=field><select id=vis_website>
                <option value=friends>my track7 friends</option>
          ...
          <div class=contactmethod>
            <label title="your twitter username or twitter profile url">
              ...
              <span class=field><input id=twitter></span>
              <span class=validation title=""><img src="/images/status/checking.gif" alt=""></span>
            </label>
            <label>
              <span class=label>show to:</span>
              <span class=field><select id=vis_twitter>
                <option value=friends>my track7 friends</option>
                <option value=all>everyone</option>
              </select></span>
            </label>
          ...
          <div class=contactmethod>
            <label title="google+ profile url">
              ...
              <span class=field><input id=google></span>
              <span class=validation title=""><img src="/images/status/checking.gif" alt=""></span>
            </label>
            <label>
              <span class=label>show to:</span>
              <span class=field><select id=vis_google>
                <option value=friends>my track7 friends</option>
                <option value=all>everyone</option>
              </select></span>
            </label>
          ...
          <div class=contactmethod>
            <label title="facebook profile url">
              ...
              <span class=field><input id=facebook></span>
              <span class=validation title=""><img src="/images/status/checking.gif" alt=""></span>
            </label>
            <label>
              <span class=label>show to:</span>
              <span class=field><select id=vis_facebook>
                <option value=friends>my track7 friends</option>
                <option value=all>everyone</option>
              </select></span>
            </label>
          ...
          <div class=contactmethod>
            <label title="steam profile url">
              ...
              <span class=field><input id=steam></span>
              <span class=validation title=""><img src="/images/status/checking.gif" alt=""></span>
            </label>
            <label>
              <span class=label>show to:</span>
              <span class=field><select id=vis_steam>
                <option value=friends>my track7 friends</option>
                <option value=all>everyone</option>
              </select></span>
            </label>
