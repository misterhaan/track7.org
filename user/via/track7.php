...
?>
      <p>
        ...
        an account from google, twitter, or facebook you will need to select its
        icon and sign in through that site instead of using the track7 icon and
        entering your username and password here.
      </p>
<?php
  }
  $html->Close();
